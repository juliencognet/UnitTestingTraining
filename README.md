...
#### 3.1.1. Tests via JUnit de la méthode computeBasketPrice de la classe BasketService
...
### 3.1.2. Tests JUnit indépendants via utilisation de doublon injectés

Dire qu'il y a d'autres façons de faire (profils Spring)

### 3.1.3. Tests JUnit indépendants via utilisation de Mockito

### 3.1.4. Tests JUnit indépendants via utilisation d'annotation magique de Spring

### 3.1.5. Tests JUnit indépendants via utilisation de H2
...
## 3.3. Sécurisation du refactoring via TDD

Corriger le fait que 2 lignes s'affichent si ajout du même produit

## 3.4. Behavior Driven Development

Implémenter la prise en compte des codes de réduction en mode Behavior Driven Development

## 3.5. Tests d'intégration d'IHM avec RobotFramework et Selenium
